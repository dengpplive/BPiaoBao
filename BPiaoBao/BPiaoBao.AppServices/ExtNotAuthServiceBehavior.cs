...
{
    public class ExtNotAuthServiceBehavior : BehaviorExtensionElement, IServiceBehavior
    {
        public override Type BehaviorType
        {
            get { return typeof(ExtNotAuthServiceBehavior); }
        }

        protected override object CreateBehavior()
        {
            return new ExtNotAuthServiceBehavior();
        }
