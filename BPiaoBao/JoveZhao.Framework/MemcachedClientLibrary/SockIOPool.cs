...
namespace JoveZhao.Framework.MemcachedClientLibrary
{
    ...
    public class SockIOPool
    {
        ...
        private static ResourceManager _resourceManager = new ResourceManager("JoveZhao.Framework.MemcachedClientLibrary.StringMessages", typeof(SockIOPool).Assembly);
